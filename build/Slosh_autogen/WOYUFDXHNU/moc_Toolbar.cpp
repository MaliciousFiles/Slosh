...
Q_CONSTINIT static const qt_meta_stringdata_CLASSToolbarENDCLASS_t qt_meta_stringdata_CLASSToolbarENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(8, 13),  // "actionChanged"
        QT_MOC_LITERAL(22, 0),  // ""
        QT_MOC_LITERAL(23, 21),  // "const ToolbarActions*"
        QT_MOC_LITERAL(45, 6),  // "action"
        QT_MOC_LITERAL(52, 13)   // "onButtonClick"
    },
    "Toolbar",
    "actionChanged",
    "",
...
Q_CONSTINIT const QMetaObject Toolbar::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSToolbarENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<const ToolbarActions *, std::false_type>,
...
void Toolbar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->actionChanged((*reinterpret_cast< std::add_pointer_t<const ToolbarActions*>>(_a[1]))); break;
        ...
        {
            using _t = void (Toolbar::*)(const ToolbarActions * );
            if (_t _q_method = &Toolbar::actionChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Toolbar::actionChanged(const ToolbarActions * _t1)
{
